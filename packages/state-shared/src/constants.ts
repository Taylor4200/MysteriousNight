const DEFAULT_BET_MODE_META = {
	...
	BONUS: {
		...
		text: {
			...
			description: 'Free Spins with a higher frequency of wild symbols appearing with random multipliers from 2x-100x, Provides 8 free spins.',
			button: 'BUY',
	...
	payTable: [
		{
			containers: [
				...
				},
				{
					...
					text: 'During Free Spins, additional spins may be awarded based on game outcomes.',
					image: 'https://staging-1-0.twist-game.app/_app/immutable/assets/wild.ac78fbf6.png',
					imagePosition: 'left',
					row: 2,
					column: 0,
